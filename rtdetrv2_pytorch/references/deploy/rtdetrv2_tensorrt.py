...
if __name__ == '__main__':
    ...
    parser.add_argument('--input-size', type=int, default=640, help="Input size used for model preprocessing (square).")
    parser.add_argument('--in-channels', type=int, choices=[1, 3], default=3, help="Model input channels: 1 for grayscale, 3 for RGB.")
    ...
    if args.in_channels == 1:
        image_model = image_pil.convert('L')
    else:
        image_model = image_pil
    ...
    image_tensor = transforms(image_model).unsqueeze(0).to(args.device)
